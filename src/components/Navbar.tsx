...
export default function Navbar() {
  ...
  return (
    <header ref={navRef} className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm transition-all">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-xl text-slate-700 hover:bg-slate-100 focus:outline-none transition-colors cursor-pointer"
            >
      ...
      {mobileMenuOpen && (
        <div id="mobile-menu" className="lg:hidden bg-white border-b border-slate-200 px-5 pt-3 pb-6 space-y-2 shadow-xl animate-in fade-in slide-in-from-top-2 duration-200">
          <a
            href="#dokumen"
