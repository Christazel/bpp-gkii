      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center text-white space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          ...
          <a
            ...
            className="w-full sm:w-auto px-8 py-3.5 text-xs sm:text-sm font-bold text-white bg-emerald-600/90 hover:bg-emerald-600 rounded-xl shadow-lg transition-all flex items-center justify-center space-x-2.5 group border border-emerald-400/30"
          >
