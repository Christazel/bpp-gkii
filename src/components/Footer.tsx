...
export default function Footer() {
  return (
    <>
      ...
      {/* FLOATING AUTHENTIC WHATSAPP HELPDESK BUTTON */}
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 flex items-center space-x-2.5 group border border-white/40"
      >
        <img
